    ...
    <div className="div-box bg-gray-600 flex h-screen w-screen items-center justify-center">
      <div className="form-box bg-white border-2 border-none rounded-md p-20">
        ...
        <form
          ...
          action=""
          className="form-area flex flex-col justify-center"
        >
          ...
          <input
            ...
            className="put outline-none bg-transparent  border-2 border-emerald-600 text-xl py-3 px-5 rounded-full placeholder:text-gray-400 mb-3"
          />
